...
git branch -M main
git remote add origin git@github.com:mexca/emvoice
```
...
and create a new repository named `emvoice` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:mexca/emvoice/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
